...
def in_hsts_preload(host: typing.AnyStr) -> bool:
    ...
    with open_pkg_binary("hstspreload.bin") as f:
        for layer, label in enumerate(labels[::-1]):
            ...
            offset, size = _JUMPTABLE[layer][_crc8(label)]
            if size == 0:
                return False
